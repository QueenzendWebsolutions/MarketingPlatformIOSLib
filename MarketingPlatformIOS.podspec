...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of MarketingPlatformIOS This project will add a done button on your TextField and TextView and move the UIView upwards if needed.'
